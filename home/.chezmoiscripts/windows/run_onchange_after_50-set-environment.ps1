...
Add-EnvPath -Container User -Path "$env:USERPROFILE\scoop\shims"

# set up fly pinyin
Write-Output "Configuring Fly Pinyin..."
cmd /c 'reg add HKCU\Software\Microsoft\InputMethod\Settings\CHS /v UserDefinedDoublePinyinScheme0 /t REG_SZ /d "小鹤双拼*2*^*iuvdjhcwfg^xmlnpbksqszxkrltvyovt" /f'